...
echo ""
echo "7. MT5 restart after an upgrade process:"
echo "      sudo systemctl stop mt5.service"
echo "      sudo systemctl kill mt5.service"
echo "      WINEPREFIX=~/.mt5 wineserver -k; pkill -9 -f wineserver; pkill -9 -f wine; pkill -9 -f explorer.exe; pkill -9 -f plugplay; kill -9 5510"
echo "      ps aux | grep -iE 'wine|terminal64|explorer' | grep -v grep"
echo "      WINEPREFIX=~/.mt5 wine terminal64.exe"
echo ""
echo "NOTES:"
