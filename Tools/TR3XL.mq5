...
////      }
   ...
   double OnTester () {
      ...
      // -------------------- Add Bot settings
      result += (string) TPMultiple + "," ;
      result += (string) SMAPeriod + "," ;
      result += (string) SMATrend + "," ;
      result += (string) RSIPeriod + "," ;
      result += (string) RSITrend + "," ;
      result += (string) ADXPeriod + "," ;
      result += (string) ADXTrend + "," ;
      result += (string) ADXTarget + "," ;
      result += (string) UseEquBal + "," ;
      result += (string) UseSession + "," ;
      result += (string) UseDaily + "," ;
      result += (string) useSMA + "," ;
      result += (string) useEMA + "," ;
      result += (string) useSMMA + "," ;
      result += (string) useDEMA + "," ;
      result += (string) useTEMA + "," ;
      result += (string) useSAR + "," ;
      result += (string) useFrama + "," ;
      result += (string) useVidya + "," ;
      result += (string) useAMA + "," ;
      ...
      result += (string) useADX + "," ;
      result += (string) useADXW + "," ;
      result += (string) UseIchi + "," ;
      result += (string) UseCloseBiggest + "," ;
